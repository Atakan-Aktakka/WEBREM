...
import SearchMemory from "../../../components/Filters/SearchMemory";

const navigation = [
  { name: "Home", href: "/", current: true },
  { name: "Share Memory", href: "/create-post", current: false },
  { name: "Memories", href: "/posts", current: false },
  { name: "Users", href: "/users", current: false },
  { name: "Add Memorial Page", href: "/add-category", current: false },
  { name: "Memorial Page List", href: "/category-list", current: false },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="animate-pulse flex-shrink-0 flex items-center text-white font-bold">
                  WEBREM
                </div>
