      ...
      <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            <p className="font-medium text-indigo-400 hover:text-indigo-500">
              Share your memories to the word. Your memories must be free from
              profanity
            </p>
          </p>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <h2 className="mt-2 text-left text-sm text-gray-600 pb-2">
                  Selected file:{addedFile.name}
                </h2>
                <Container className="container bg-gray-700">
                  <Dropzone
                    onBlur={formik.handleBlur("image")}
                    accept="image/jpeg, image/png, .mp4,.mkv,.avi"
