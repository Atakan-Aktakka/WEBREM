        ...
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0">
            ...
            <Link
              ...
              className=" text-gray-600 inline-block py-1 px-2 text-center mr-2 mb-1 lg:mb-0 text-xs border-2 border-yellow-500 rounded  "
            >
              Profile
            </Link>
            ...
            <button
              ...
              className="inline-flex  justify-center bg-gray-700 px-2   border border-yellow-700 shadow-sm text-sm font-medium rounded-md text-gray-500  hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
            >
              <MailIcon
                className="my-auto -ml-1 mr-2 h-5 w-5 text-gray-200"
                aria-hidden="true"
              />
              <span className="my-auto  text-base mr-2  text-bold text-gray-200">
                Message
              </span>
            </button>
          </div>
